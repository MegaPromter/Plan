...
depts = [
    {"id":1,"code":"001","ntc":2},{"id":2,"code":"002","ntc":2},
    {"id":3,"code":"003","ntc":2},{"id":4,"code":"201","ntc":3},
    {"id":5,"code":"202","ntc":3},{"id":6,"code":"204","ntc":3},
    {"id":7,"code":"207","ntc":3},{"id":8,"code":"208","ntc":3},
    {"id":9,"code":"209","ntc":3},{"id":10,"code":"231","ntc":3},
    {"id":11,"code":"301","ntc":4},{"id":12,"code":"302","ntc":4},
    {"id":13,"code":"303","ntc":4},{"id":14,"code":"304","ntc":4},
    {"id":15,"code":"401","ntc":5},{"id":16,"code":"402","ntc":5},
    {"id":18,"code":"403","ntc":5},{"id":17,"code":"404","ntc":5},
]

last_m = [
    'Иванов','Петров','Сидоров','Кузнецов','Смирнов','Попов','Васильев','Соколов',
    'Михайлов','Новиков','Морозов','Волков','Алексеев','Лебедев','Козлов','Степанов',
    'Николаев','Орлов','Андреев','Макаров','Никитин','Захаров','Зайцев','Борисов',
    'Яковлев','Романов','Сергеев','Александров','Дмитриев','Гусев','Ильин','Максимов',
    'Поляков','Сорокин','Белов','Медведев','Антонов','Тарасов','Жуков','Баранов',
    'Филиппов','Комаров','Давыдов','Беляев','Герасимов','Богданов','Осипов','Матвеев',
    'Титов','Марков','Миронов','Крылов','Куликов','Карпов','Власов','Денисов',
    'Гаврилов','Тихонов','Казаков','Данилов','Тимофеев',
]

last_f = [
    'Иванова','Петрова','Сидорова','Кузнецова','Смирнова','Попова','Васильева',
    'Соколова','Михайлова','Новикова','Морозова','Волкова','Алексеева','Лебедева',
    'Козлова','Степанова','Николаева','Орлова','Андреева','Макарова','Никитина',
    'Захарова','Зайцева','Борисова','Яковлева','Романова',
]

first_m = [
    'Александр','Дмитрий','Сергей','Андрей','Алексей','Михаил','Иван','Максим',
    'Владимир','Евгений','Николай','Павел','Роман','Олег','Виктор','Денис','Игорь',
    'Антон','Константин','Юрий','Вадим','Григорий','Борис','Василий','Тимофей',
    'Кирилл','Леонид','Валерий','Геннадий',
]

first_f = [
    'Анна','Елена','Ольга','Наталья','Мария','Екатерина','Татьяна','Ирина',
    'Светлана','Юлия','Дарья','Алина','Марина','Виктория','Галина','Надежда',
]

pat_m = [
    'Александрович','Дмитриевич','Сергеевич','Андреевич','Алексеевич','Михайлович',
    'Иванович','Владимирович','Евгеньевич','Николаевич','Павлович','Олегович',
    'Викторович','Игоревич','Петрович','Юрьевич','Борисович','Валерьевич',
]

pat_f = [
    'Александровна','Дмитриевна','Сергеевна','Андреевна','Алексеевна','Михайловна',
    'Ивановна','Владимировна','Евгеньевна','Николаевна','Павловна','Олеговна',
    'Викторовна','Игоревна','Петровна','Юрьевна','Борисовна','Валерьевна',
]

positions = [
    'tech_3','tech_2','tech_1','spec','spec_2','spec_1','lead_spec',
    'eng','eng_3','eng_2','eng_1','lead_eng','lead_eng_dir_3','lead_eng_dir_2',
    'lead_eng_coord','bureau_head','jr_researcher','sr_researcher','lead_researcher',
    'sector_head','dept_deputy','dept_head',
]
...
tr_map = {
    ...
    'ш':'sh','щ':'sch','ъ':'','ы':'y','ь':'','э':'e','ю':'yu','я':'ya','_':'_',
}
...
'''.format(data_json=json.dumps(emps, ensure_ascii=False))
