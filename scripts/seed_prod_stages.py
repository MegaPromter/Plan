...
stages_template = [
    ...
    {
        "num": "3.5",
        "name": "Разработка общей документации",
        "wo": "НЗ-0987",
        "rc": "КС-874",
        "order": 4,
    },
...
""".format(
    tpl=json.dumps(stages_template, ensure_ascii=False)
)
