...
PROJECT_TEMPLATES = [
    {
        "name_full": 'Проект "РОС" -- Разработка оптических систем',
        "name_short": "РОС",
        "code": "ПР-РОС-2026",
    },
    {
        "name_full": 'Проект "Персей" -- Перспективные системы единой ядерной',
        "name_short": "Персей",
        "code": "ПР-ПЕР-2026",
    },
    {
        "name_full": 'Проект "Орион" -- Опытная разработка интегрированных объектов навигации',
        "name_short": "Орион",
        "code": "ПР-ОРН-2026",
    },
    {
        "name_full": 'Проект "Каскад" -- Комплексная автоматизация систем контроля',
        "name_short": "Каскад",
        "code": "ПР-КСК-2026",
    },
    {
        "name_full": 'Проект "Гранит" -- Глобальная разработка навигационных технологий',
        "name_short": "Гранит",
        "code": "ПР-ГРН-2026",
    },
    {
        "name_full": 'Проект "Байкал" -- Базовые исследования конструкций аэрокосмических летательных',
        "name_short": "Байкал",
        "code": "ПР-БКЛ-2026",
    },
]
    ...
    for pp in pp_plans:
        ...
        for row_idx in range(nrows):
            ...
            if data and data.get("id"):
                ...
                client.metrics.report_bug(f"500 creating PP row: {resp.text[:200]}")
    ...
    for pp in pp_plans:
        ...
        if data:
            ...
            if resp and resp.status_code >= 500:
                client.metrics.report_bug(f"500 syncing PP->SP: {pp['name']}")
