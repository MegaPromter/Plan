    ...
    for ann in annotations:
        ...
        if lbl and lpos:
            ...
            if box:
                ...
                bb = ImageDraw.Draw(img).textbbox(
                    lpos, lbl, font=get_font(ann.get("font_size", 22))
                )
                lbl_cx = (bb[0] + bb[2]) // 2
                lbl_cy = bb[3] + 5
...
def make_all():
    ...
    make_annotated_full(
        "pp_table.png",
        "pp_table_annotated.png",
        [
            {
                "box": (255, 58, 950, 85),
                "label": "① Статусная панель",
                "label_pos": (960, 60),
                "color": (255, 68, 68),
            },
            {
            ...
            {
                "box": (255, 115, 1920, 145),
                "label": "③ Заголовки + фильтры",
                "label_pos": (1400, 116),
                "color": (26, 115, 232),
            },
        ],
    ...
    label(
        c,
        "Поиск | Добавить строку | Синхронизация | Статистика | Промилле",
        (10, 10),
        size=18,
    )
    ...
    make_annotated_full(
        ...
        [
            ...
            {
                "box": (255, 20, 1500, 55),
                "label": "② Тулбар (+ Задача, Ошибки, Плотность, Столбцы)",
                "label_pos": (800, 2),
                "color": (34, 168, 83),
            },
            {
                "box": (255, 80, 1920, 120),
                "label": "③ Заголовки с фильтрами",
                "label_pos": (1400, 78),
                "color": (26, 115, 232),
            },
        ],
    ...
    make_annotated_full(
        ...
        [
            {
                "box": (300, 55, 1640, 95),
                "label": "① Переключатель периода",
                "label_pos": (1100, 38),
                "color": (255, 68, 68),
            },
            {
                "box": (300, 95, 1640, 220),
                "label": "② Карточки показателей",
                "label_pos": (1100, 222),
                "color": (34, 168, 83),
            },
            {
                "box": (300, 240, 1640, 510),
                "label": "③ Блок Команда",
                "label_pos": (1100, 510),
                "color": (26, 115, 232),
            },
    ...
    make_annotated_full(
        ...
        [
            ...
            {
                "box": (1830, 60, 1915, 500),
                "label": "Статусы (цветовые)",
                "label_pos": (1650, 500),
                "color": (255, 68, 68),
            },
        ],
    ...
    make_annotated_full(
        "analytics.png",
        "analytics_annotated.png",
        [
            {
                "box": (300, 80, 1500, 130),
                "label": "① Карточки-итоги",
                "label_pos": (1100, 62),
                "color": (255, 68, 68),
            },
            {
                "box": (300, 130, 1500, 370),
                "label": "② Графики загрузки",
                "label_pos": (1100, 372),
                "color": (34, 168, 83),
            },
            {
                "box": (300, 390, 1500, 540),
                "label": "③ Таблица по отделам",
                "label_pos": (1100, 540),
                "color": (26, 115, 232),
            },
        ],
    ...
    make_annotated_full(
        ...
        [
            {
                "box": (255, 30, 800, 280),
                "label": "① Сводная таблица часов",
                "label_pos": (810, 100),
                "color": (255, 68, 68),
            },
            {
                "box": (255, 290, 1920, 540),
                "label": "② Мини-календари",
                "label_pos": (1000, 545),
                "color": (34, 168, 83),
            },
        ],
