...
from django.urls import (  # path — создание маршрута; include — подключение вложенных URLconf
    include,
    path,
)
from django.views.generic import (  # класс-view для HTTP-редиректа без написания функции
    RedirectView,
)
