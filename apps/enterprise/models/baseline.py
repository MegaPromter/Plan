...
class BaselineSnapshot(models.Model):
    ...
    cross_schedule = models.ForeignKey(
        'enterprise.CrossSchedule', on_delete=models.CASCADE,
        related_name='baselines', verbose_name='Сквозной график',
    )
...
class BaselineEntry(models.Model):
    ...
    snapshot = models.ForeignKey(
        BaselineSnapshot, on_delete=models.CASCADE,
        related_name='entries', verbose_name='Снимок',
    )
    work = models.ForeignKey(
        'works.Work', on_delete=models.SET_NULL,
