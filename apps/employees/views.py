...
class VacationPlanView(LoginRequiredMixin, ListView):
    ...
    def get_queryset(self):
        ...
        q = self.request.GET.get("q", "").strip()
        if q:
            qs = qs.filter(employee__last_name__icontains=q) | qs.filter(
    ...
    def get_context_data(self, **kwargs):
        ...
        ctx["departments"] = __import__(
            "apps.employees.models", fromlist=["Department"]
...
class VacationCreateView(WriterRequiredMixin, CreateView):
    ...
    def get_success_url(self):
        ...
        return reverse_lazy(
            "employees:vacation_list", kwargs={"emp_pk": self.kwargs["emp_pk"]}
        )
...
class VacationUpdateView(WriterRequiredMixin, UpdateView):
    ...
    def get_success_url(self):
        ...
        return reverse_lazy(
            "employees:vacation_list", kwargs={"emp_pk": self.object.employee_id}
        )
...
class KPICreateView(WriterRequiredMixin, CreateView):
    ...
    def get_success_url(self):
        ...
        return reverse_lazy(
            "employees:kpi_list", kwargs={"emp_pk": self.kwargs["emp_pk"]}
        )
...
class KPIUpdateView(WriterRequiredMixin, UpdateView):
    ...
    def get_success_url(self):
        ...
        return reverse_lazy(
            "employees:kpi_list", kwargs={"emp_pk": self.object.employee_id}
        )
