...
SEED_NTC_CENTERS = [
    'НТЦ-1Ц', 'НТЦ-2Ц', 'НТЦ-3Ц', 'НТЦ-4Ц',
    'НТЦ-7Ц', 'НТЦ-8Ц', 'НТЦ-11Ц', 'НТЦ-13Ц', 'НТЦ-14Ц',
]

SEED_POSITIONS = [
    'техник-конструктор', 'техник-конструктор 2 кат.',
    'техник-конструктор 1 кат.',
    'специалист', 'специалист 2 кат.', 'специалист 1 кат.',
    'инженер-конструктор 3 кат.', 'инженер-конструктор 2 кат.',
    'инженер-конструктор 1 кат.',
    'ведущий инженер-конструктор', 'начальник сектора',
    'зам. начальника отдела', 'начальник отдела',
    'руководитель направления', 'зам. руководителя НТЦ',
    'руководитель НТЦ', 'техник',
]

SEED_TASK_TYPES = [
    'Разработка', 'Выпуск нового документа',
    'Корректировка документа', 'Сопровождение (ОКАН)',
]

SEED_WORK_NAMES = [
    'Разработка технического задания', 'Тестирование модуля',
    'Проектирование общего вида', 'Разработка деталировки',
    'Корректировка документации', 'Выпуск спецификации',
    'Разработка сборочного чертежа', 'Согласование ТУ',
    'Проведение расчётов', 'Подготовка отчёта',
    'Выпуск электрической схемы', 'Анализ аналогов',
    'Разработка монтажного чертежа', 'Составление ведомости',
    'Оформление пояснительной записки', 'Выпуск габаритного чертежа',
    'Техническое сопровождение', 'Авторский надзор',
    'Входной контроль', 'Разработка программы испытаний',
]
...
SEED_DEPTS = [
    '021', '022', '024', '027', '028', '029', '301', '082', '084', '086',
]
...
_SEED_EXECUTORS = [
    'Иванов И.И.', 'Петров П.П.', 'Сидорова А.В.', 'Козлов М.С.',
    'Новикова Е.А.', 'Морозов Д.В.', 'Лебедева О.Н.', 'Соколов А.П.',
    'Попова Т.И.', 'Волков К.Ю.',
]
...
def _get_or_create_sector(dept, sector_code):
    ...
    sector, _ = Sector.objects.get_or_create(
        department=dept, code=sector_code, defaults={'name': ''},
    )
    return sector
        ...
        with transaction.atomic():
            ...
            if new_names:
                Directory.objects.bulk_create([
                    Directory(dir_type='executor', value=name)
