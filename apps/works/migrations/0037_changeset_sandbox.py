...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "reject_comment",
                    models.TextField(
                        blank=True, default="", verbose_name="Причина отклонения"
                    ),
                ),
                (
                    "created_at",
                ...
                (
                    "reviewed_at",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Дата рецензии"
                    ),
                ),
                (
                    "published_at",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["changeset"], name="work_change_changes_4cecd3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="changesetitem",
            index=models.Index(
                fields=["target_row"], name="work_change_target__af9560_idx"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="changeset",
            index=models.Index(
                fields=["department"], name="work_change_departm_d5e8ac_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="changeset",
            index=models.Index(
                fields=["pp_project"], name="work_change_pp_proj_865a40_idx"
            ),
        ),
    ]
