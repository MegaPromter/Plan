...
def migrate_data_forward(apps, schema_editor):
    ...
    for tw in task_works:
        ...
        w.executors_list = tw.executors_list if isinstance(tw.executors_list, list) else []
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='work',
            name='stage',
            field=models.CharField(blank=True, default='', max_length=100, verbose_name='№ Этапа'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='work',
            name='justification',
            field=models.CharField(blank=True, default='', max_length=500, verbose_name='Основание'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='work',
            name='executors_list',
            field=models.JSONField(blank=True, default=list, verbose_name='Список исполнителей'),
        ),
        migrations.AddField(
            model_name='work',
            name='actions',
            field=models.JSONField(blank=True, default=dict, verbose_name='Связи / доп. данные'),
        ),
        # Поля из PPWork
        migrations.AddField(
            model_name='work',
        ...
        migrations.AddField(
            model_name='work',
            name='row_code',
            field=models.CharField(blank=True, default='', max_length=50, verbose_name='Код строки'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='work',
            name='work_order',
            field=models.CharField(blank=True, default='', max_length=100, verbose_name='Заказ-наряд'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='work',
            name='stage_num',
            field=models.CharField(blank=True, default='', max_length=50, verbose_name='Этап'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='work',
            name='milestone_num',
            field=models.CharField(blank=True, default='', max_length=50, verbose_name='Подэтап'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='work',
            name='work_num',
            field=models.CharField(blank=True, default='', max_length=50, verbose_name='Номер работы'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='work',
            name='work_designation',
            field=models.CharField(blank=True, default='', max_length=200, verbose_name='Обозначение'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='work',
            name='sheets_a4',
            field=models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True, verbose_name='Листы А4'),
        ),
        migrations.AddField(
            model_name='work',
            name='norm',
            field=models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True, verbose_name='Норма (чел.-ч)'),
        ),
        migrations.AddField(
            model_name='work',
            name='coeff',
        ...
        migrations.AddField(
            model_name='work',
            name='total_2d',
            field=models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True, verbose_name='Трудоёмкость 2D'),
        ),
        migrations.AddField(
            model_name='work',
            name='total_3d',
            field=models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True, verbose_name='Трудоёмкость 3D'),
        ),
        migrations.AddField(
            model_name='work',
            name='labor',
            field=models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True, verbose_name='Трудозатраты итого'),
        ),
        migrations.AddField(
            model_name='work',
            name='sector_head_name',
            field=models.CharField(blank=True, default='', max_length=200, verbose_name='Начальник сектора'),
            preserve_default=False,
        ),
