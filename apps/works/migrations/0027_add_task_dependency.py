...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("FS", "Окончание–Начало (FS)"),
                            ("SS", "Начало–Начало (SS)"),
                            ("FF", "Окончание–Окончание (FF)"),
                            ("SF", "Начало–Окончание (SF)"),
                        ],
                        default="FS",
                        max_length=2,
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["predecessor"], name="work_task_d_predece_0686bd_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="taskdependency",
            index=models.Index(
                fields=["successor"], name="work_task_d_success_ef9328_idx"
            ),
        ),
