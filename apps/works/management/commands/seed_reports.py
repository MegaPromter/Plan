...
DOC_NAMES = [
    'Чертёж общего вида', 'Сборочный чертёж', 'Спецификация', 'Схема электрическая',
    'Расчёт прочности', 'Расчёт теплового режима', 'Ведомость покупных',
    'Программа испытаний', 'Технические условия', 'Пояснительная записка',
    'Расчёт надёжности', 'Монтажный чертёж', 'Габаритный чертёж',
    'Ведомость согласования', 'Акт проверки', 'Протокол испытаний',
    'Ведомость комплекта', 'Паспорт изделия', 'Формуляр',
]
